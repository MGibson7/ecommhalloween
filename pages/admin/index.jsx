...
const Index = ({orders, products}) => {
    ...
    const handleStatus = async (id) =>{
        ...
        try{
            const res = await axios.put("http://localhost:3000/api/products/orders/"+id, {status:currentStatus+1});
            setOrderList([
                res.data,
...
export const getServerSideProps = async(ctx) => {
    ...
    const orderRes = await axios.get("http://localhost:3000/api/products/orders")
